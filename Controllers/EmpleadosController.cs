...
namespace VideoExplicativoAspNet.Controllers
{
    public class EmpleadosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("EmpleadoId,Nombre,DepartamentoId")] Empleado empleado)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EmpleadoId,Nombre,DepartamentoId")] Empleado empleado)
        {
